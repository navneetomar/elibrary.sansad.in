...
import { WorkflowItemSearchResultAdminWorkflowTableElementComponent } from './admin-workflow-search-results/admin-workflow-search-result-table-element/workflow-item/workflow-item-search-result-admin-workflow-table-element.component';

const ENTRY_COMPONENTS = [
  // put only entry components that use custom decorator
  WorkflowItemSearchResultAdminWorkflowListElementComponent,
  WorkflowItemSearchResultAdminWorkflowGridElementComponent,
  WorkflowItemSearchResultAdminWorkflowTableElementComponent,
];
