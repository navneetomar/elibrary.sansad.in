 ...
 */
@Component({
  selector: 'ds-item-page-file-section-journal',
  templateUrl: './file-section-journal.component.html',
  styleUrls: ['./file-section-journal.component.scss'],
})
export class FileSectionJournalComponent implements OnInit {
  @Input() item: Item;
