 ...
 */
@Component({
  selector: 'ds-item-page-file-section-other',
  templateUrl: './file-section-other.component.html',
  styleUrls: ['./file-section-other.component.scss'],
})
export class FileSectionOtherComponent implements OnInit {
  @Input() item: Item;
