...
export class CommunityListService {
  ...
  getDataCommunities() {
    const url = 'https://api7.dspace.org';
    return this.http.get<any>(
      `${url}/server/api/core/communities/search/top?page=0&size=100&sort=dc.title,ASC&embed.size=subcommunities=1&embed=subcommunities&embed.size=collections=1&embed=collections`
    );
  }
  /**
