...
@listableObjectComponent(ItemSearchResult, ViewMode.GridElement, Context.Workspace)
@listableObjectComponent(ItemSearchResult, ViewMode.GridElement, Context.Workflow)
