...
export class ComColFormComponent<T extends Collection | Community | Topic>
  implements OnInit, OnDestroy
{
   ...
   */
  protected dsoService: ComColDataService<Community | Collection | Topic>;
  ...
  onSubmit() {
    ...
    if (this.isTopic === true) {
      updatedDSO = Object.assign({}, this.dso, {
        metadata: {
          ...this.dso.metadata,
          ...formMetadata,
        },
