    ...
    if (this.isTablePolicy === false) {
      ...
      if (this.resourceType === COMMUNITY_TYPE) {
        this.router.navigate(
          [`/communities/${this.resourceUUID}/edit/authorizations/edit`],
          {
            queryParams: {
              policyId: this.entry.policy.id,
            },
        ...
        this.router.navigate(
          [`/collections/${this.resourceUUID}/edit/authorizations/edit`],
          {
            queryParams: {
              policyId: this.entry.policy.id,
            },
        ...
        this.router.navigate(
          [`/items/${this.resourceUUID}/edit/authorizations/edit`],
          {
            queryParams: {
              policyId: this.entry.policy.id,
            },
        ...
        this.router.navigate(
          [`/bitstreams/${this.resourceUUID}/authorizations/edit`],
          {
            queryParams: {
              policyId: this.entry.policy.id,
            },
