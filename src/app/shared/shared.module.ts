import { AdminStatisticsService } from './../admin/admin-statistics/admin-statistics.service';
import { AdminPoliciesService } from './../admin/admin-policies/admin-policies.service';
import { SearchResultLogoService } from './object-list/search-result-list-element/search-result-logo.service';
import { CommunityLogoComponent } from './object-list/community-list-element/community-logo/community-logo.component';
import { PersonStaticsService } from './../entity-groups/research-entities/item-pages/person/person-statics/person-statics.service';
...
import { CreateTopicParentSelectorComponent } from './dso-selector/modal-wrappers/create-topic-parent-selector/create-topic-parent-selector.component';
...
import { ThemedCreateTopicParentSelectorComponent } from './dso-selector/modal-wrappers/create-topic-parent-selector/themed-create-topic-parent-selector.component';
...
import { TopicSearchResultListElementComponent } from './object-list/search-result-list-element/topic-search-result/topic-search-result-list-element.component';
...
import { EditTopicSelectorComponent } from './dso-selector/modal-wrappers/edit-topic-selector/edit-topic-selector.component';
import { ThemedEditTopicSelectorComponent } from './dso-selector/modal-wrappers/edit-topic-selector/themed-edit-topic-selector.component';
...
import { DownloadViewWrapperComponent } from '../item-page/download-view-components/download-view-wrapper/download-view-wrapper.component';
import { DownloadViewWrapperService } from '../item-page/download-view-components/download-view-wrapper/download-view-wrapper.service';
...
import { TopicSidebarSearchListElementComponent } from './object-list/sidebar-search-list-element/topic/topic-sidebar-search-list-element.component';
...
import { AuthorProfileComponent } from '../sidebar-left/author-profile/author.profile.component';

import { ThemedSidebarLeftComponent } from '../sidebar-left/themed-sidebar-left.component';
...
import { TreeDropDragService } from '../admin/admin-policies/tree-drop-drag/tree-drop-drag.service';

import { AuthorProfileService } from '../sidebar-left/author-profile/author-profile.service';
import { TopicInfoService } from '../sidebar-left/topic-info/topic-info.service';
import { TopicInfoComponent } from '../sidebar-left/topic-info/topic-info.component';
import { CommunityLogoService } from './object-list/community-list-element/community-logo/community-logo.service';
import { FileSectionJournalComponent } from '../entity-groups/journal-entities/item-pages/file-section-journal/file-section-journal.component';
import { FileSectionOtherComponent } from '../entity-groups/research-entities/item-pages/file-section-other/file-section-other.component';
import { FileStatisticsComponent } from '../item-page/simple/field-components/file-statistics/file-statistics.component';
import { BannerComponent } from '../banner/banner.component';
import { CollectionTableElementComponent } from './object-table/collection-table-element/collection-table-element.component';
import { CommunityTableElementComponent } from './object-table/community-table-element/community-table-element.component';
import { ObjectTableComponent } from './object-table/object-table.component';
import { SearchResultTableElementComponent } from './object-table/search-result-table-element/search-result-table-element.component';
import { RECAPTCHA_SETTINGS, RecaptchaFormsModule, RecaptchaModule, RecaptchaSettings } from 'ng-recaptcha';
import { CollectionSearchResultTableElementComponent } from './object-table/search-result-table-element/collection-search-result/collection-search-result-table-element.component';
import { CommunitySearchResultTableElementComponent } from './object-table/search-result-table-element/community-search-result/community-search-result-table-element.component';
import { ItemTableElementComponent } from './object-table/item-table-element/item-types/item/item-table-element.component';
import { ItemSearchResultTableElementComponent } from './object-table/search-result-table-element/item-search-result/item/item-search-result-table-element.component';
...
const COMPONENTS = [
  ...
  CreateTopicParentSelectorComponent,
  ThemedCreateCommunityParentSelectorComponent,
  ThemedCreateTopicParentSelectorComponent,
  CreateCollectionParentSelectorComponent,
  ThemedCreateCollectionParentSelectorComponent,
  CreateItemParentSelectorComponent,
  ThemedCreateItemParentSelectorComponent,
  EditCommunitySelectorComponent,
  EditTopicSelectorComponent,
  ThemedEditCommunitySelectorComponent,
  ThemedEditTopicSelectorComponent,
  EditCollectionSelectorComponent,
  ThemedEditCollectionSelectorComponent,
  EditItemSelectorComponent,
  ThemedEditItemSelectorComponent,
  CommunitySearchResultListElementComponent,
  TopicSearchResultListElementComponent,
  CollectionSearchResultListElementComponent,
  BrowseByComponent,

  CollectionSearchResultGridElementComponent,
  CommunitySearchResultGridElementComponent,
  CollectionSearchResultTableElementComponent,
  CommunitySearchResultTableElementComponent,
  ...
  CommunityTableElementComponent,
  CollectionTableElementComponent,
  ...
  SearchResultTableElementComponent,
  ItemListElementComponent,
  ItemGridElementComponent,
  ItemTableElementComponent,
  ItemSearchResultGridElementComponent,
  ItemSearchResultTableElementComponent,
  ...
  TopicSidebarSearchListElementComponent,
  ...
  ThemedSidebarLeftComponent,
  FileSectionJournalComponent,
  FileSectionOtherComponent,
  BannerComponent
];
...
const PROVIDERS = [
  ...
  DownloadViewWrapperService,
  PersonStaticsService,
  AuthorProfileService,
  TopicInfoService,
  CommunityLogoService,
  SearchResultLogoService,
  {
