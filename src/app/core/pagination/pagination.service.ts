...
export class PaginationService {
  ...
  constructor(protected routeService: RouteService, protected router: Router, public location: Location) {}
  ...
  getCurrentPagination(
    ...
    const pageSize = this.location.path().includes('/access-control/groups') ? 5 : 12;
