...
import { ThemedCreateTopicParentSelectorComponent } from './shared/dso-selector/modal-wrappers/create-topic-parent-selector/themed-create-topic-parent-selector.component';
...
import { ThemedEditTopicSelectorComponent } from './shared/dso-selector/modal-wrappers/edit-topic-selector/themed-edit-topic-selector.component';
...
export class MenuResolver implements Resolve<boolean> {
  ...
  createPublicMenu$(): Observable<boolean> {
    const menuList: any[] = [
      ...
      //     text: 'menu.section.browse_global_home_page',
      //     link: `/home`,
      ...
      .subscribe(
        (browseDefListRD: RemoteData<PaginatedList<BrowseDefinition>>) => {
          if (browseDefListRD.hasSucceeded) {
            ...
            menuList.push({
              id: `browse_global_communities_and_collections_2`,
              active: false,
              visible: false,
              index: 2,
              model: {
            ...
            menuList.push({
              id: `browse_global_communities_and_collections_3`,
              active: false,
              visible: false,
              index: 3,
              model: {
                type: MenuItemType.LINK,
                text: 'menu.section.browse_global_contact',
                link: `info/contact`,
              } as LinkMenuItemModel,
            });
          }
  ...
  createMainMenuSections() {
    combineLatest([
      ...
      this.authorizationService.isAuthorized(FeatureID.IsTopicAdmin),
      this.authorizationService.isAuthorized(FeatureID.AdministratorOf),
    ]).subscribe(
      ([isCollectionAdmin, isCommunityAdmin, isTopicAdmin, isSiteAdmin]) => {
        const menuList = [
          /* News */
          {
            id: 'new',
          ...
          },
          {
            ...
            parentID: 'new',
            active: false,
            visible: isTopicAdmin,
            model: {
              type: MenuItemType.ONCLICK,
              text: 'menu.section.new_topic',
              function: () => {
                this.modalService.open(
          ...
          },
          {
            ...
            model: {
              type: MenuItemType.ONCLICK,
              text: 'menu.section.edit_topic',
              function: () => {
                this.modalService.open(ThemedEditTopicSelectorComponent);
              },
            } as OnClickMenuItemModel,
          },
          {
    ...
    this.authorizationService
      ...
      .subscribe((authorized) => {
        const menuList = [
          ...
          // {
          //   id: 'policies_metadata',
          //   parentID: 'policies',
          //   active: false,
          //   visible: authorized,
          //   model: {
          //     type: MenuItemType.LINK,
          //     text: 'menu.section.policies_metadata',
          //     link: 'admin/policies',
          //   } as LinkMenuItemModel,
          // },
          // /* Statistics */
          ...
          //   model: {
          //     type: MenuItemType.LINK,
          //     text: 'menu.section.statistics_admin',
